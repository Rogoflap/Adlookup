...
Partial Class SCCMReports
    ...
    Private Sub InitializeComponent()
        ...
        Me.labelcmb = New System.Windows.Forms.Label()
        Me.tbParameter = New System.Windows.Forms.TextBox()
        ...
        Me.DtDiskSpaceTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtDiskSpaceTableAdapter()
        Me.DtFilesListTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtFilesListTableAdapter()
        Me.DtSoftwareInstalledByUserTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtSoftwareInstalledByUserTableAdapter()
        ...
        Me.DtAdvertisementDetailTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtAdvertisementDetailTableAdapter()
        Me.DtAddRemoveProgramsReportsTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtAddRemoveProgramsReportsTableAdapter()
        Me.DtCompInfoReportTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtCompInfoReportTableAdapter()
        Me.DtComputerListAllTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtComputerListAllTableAdapter()
        Me.DtPackageDistributionTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtPackageDistributionTableAdapter()
        Me.DtAdvertisementSummaryTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtAdvertisementSummaryTableAdapter()
        Me.DtCollectionTableAdapter1 = New ADLookup.SMS_EAIDataSetTableAdapters.dtCollectionTableAdapter()
        ...
        'labelcmb
        '
        Me.labelcmb.AutoSize = True
        Me.labelcmb.Location = New System.Drawing.Point(10, 12)
        Me.labelcmb.Name = "labelcmb"
        Me.labelcmb.Size = New System.Drawing.Size(39, 13)
        Me.labelcmb.TabIndex = 2
        Me.labelcmb.Text = "Report"
        '
        'tbParameter
        '
        Me.tbParameter.Location = New System.Drawing.Point(262, 27)
        Me.tbParameter.Name = "tbParameter"
        Me.tbParameter.Size = New System.Drawing.Size(134, 20)
        Me.tbParameter.TabIndex = 3
        '
        'labelParam
        '
        Me.labelParam.AutoSize = True
        Me.labelParam.Location = New System.Drawing.Point(259, 14)
        Me.labelParam.Name = "labelParam"
        Me.labelParam.Size = New System.Drawing.Size(55, 13)
        Me.labelParam.TabIndex = 4
        Me.labelParam.Text = "Parameter"
        '
        'btnGetData
        '
        ...
        Me.cmbReport.Items.AddRange(New Object() {"Add Remove Programs by Program Name", "Advertisement ALL Summary Status ", "Advertisement Detail ALL Computers", "Collection ALL Machines", "Computers All", "Computers with File Name", "Diskspace Less Than # GB", "Package Distribution ALL Summary", "Software Updates by KBArticle"})
        Me.cmbReport.Location = New System.Drawing.Point(12, 26)
        Me.cmbReport.Name = "cmbReport"
        Me.cmbReport.Size = New System.Drawing.Size(218, 21)
        Me.cmbReport.TabIndex = 1
        Me.cmbReport.Text = " Please Pick Report from this list"
        '
        'cmbSite
        '
        Me.cmbSite.FormattingEnabled = True
        Me.cmbSite.Items.AddRange(New Object() {"ANY", "CHA", "EAI"})
        Me.cmbSite.Location = New System.Drawing.Point(421, 26)
        Me.cmbSite.Name = "cmbSite"
        Me.cmbSite.Size = New System.Drawing.Size(91, 21)
        Me.cmbSite.TabIndex = 4
        Me.cmbSite.Tag = "East Alton (EAI), Chlor (CHA) , ANY (Both)"
        Me.cmbSite.Text = "EAI"
        '
        'Label3
        '
        ...
        Me.Label21.Size = New System.Drawing.Size(163, 29)
        Me.Label21.TabIndex = 76
        Me.Label21.Text = "SCCM  INFO"
        '
        'StatusStrip1
        '
        ...
        '
        'DtDiskSpaceTableAdapter1
        '
        Me.DtDiskSpaceTableAdapter1.ClearBeforeFill = True
        '
        'DtFilesListTableAdapter1
        '
        Me.DtFilesListTableAdapter1.ClearBeforeFill = True
        '
        'DtSoftwareInstalledByUserTableAdapter1
        '
        Me.DtSoftwareInstalledByUserTableAdapter1.ClearBeforeFill = True
        '
        ...
        '
        'DtAdvertisementDetailTableAdapter1
        '
        Me.DtAdvertisementDetailTableAdapter1.ClearBeforeFill = True
        '
        'DtAddRemoveProgramsReportsTableAdapter1
        '
        Me.DtAddRemoveProgramsReportsTableAdapter1.ClearBeforeFill = True
        '
        'DtCompInfoReportTableAdapter1
        '
        Me.DtCompInfoReportTableAdapter1.ClearBeforeFill = True
        '
        'DtComputerListAllTableAdapter1
        '
        Me.DtComputerListAllTableAdapter1.ClearBeforeFill = True
        '
        'DtPackageDistributionTableAdapter1
        '
        Me.DtPackageDistributionTableAdapter1.ClearBeforeFill = True
        '
        'DtAdvertisementSummaryTableAdapter1
        '
        Me.DtAdvertisementSummaryTableAdapter1.ClearBeforeFill = True
        '
        'DtCollectionTableAdapter1
        '
        Me.DtCollectionTableAdapter1.ClearBeforeFill = True
        '
        'Button1
        '
        ...
        Me.Controls.Add(Me.tbParameter)
        Me.Controls.Add(Me.labelcmb)
    ...
    Friend WithEvents labelcmb As System.Windows.Forms.Label
    Friend WithEvents tbParameter As System.Windows.Forms.TextBox
    ...
    Public WithEvents DtDiskSpaceTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtDiskSpaceTableAdapter
    Public WithEvents DtFilesListTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtFilesListTableAdapter
    Public WithEvents DtSoftwareInstalledByUserTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtSoftwareInstalledByUserTableAdapter
    Public WithEvents DtAddRemoveProgramsTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtAddRemoveProgramsTableAdapter
    Public WithEvents DtSoftwareUpdatesTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtSoftwareUpdatesTableAdapter
    ...
    Friend WithEvents DtAddRemoveProgramsReportsTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtAddRemoveProgramsReportsTableAdapter
    Friend WithEvents DtCompInfoReportTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtCompInfoReportTableAdapter
    Friend WithEvents Label21 As System.Windows.Forms.Label
    Friend WithEvents DtComputerListAllTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtComputerListAllTableAdapter
    ...
    Friend WithEvents DtPackageDistributionTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtPackageDistributionTableAdapter
    Friend WithEvents DtAdvertisementSummaryTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtAdvertisementSummaryTableAdapter
    Friend WithEvents DtCollectionTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtCollectionTableAdapter
    Friend WithEvents DtAdvertisementDetailTableAdapter1 As ADLookup.SMS_EAIDataSetTableAdapters.dtAdvertisementDetailTableAdapter
