Public Class PrintDGV
    ...
    Public Shared Sub Print_DataGridView(ByVal DataGridView1 As DataGridView, Optional sTitle As String = "Results:", Optional bAllRows As Boolean = True)
        Dim ppvw As PrintPreviewDialog
        Try
            ' Getting DataGridView object to print
            dgv = DataGridView1
            PrintAllRows = bAllRows
            ...
            PrintTitle = "Results from : " & sTitle 'dt.TableName 'dlg.PrintTitle
